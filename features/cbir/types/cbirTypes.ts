...
// Respuesta completa del endpoint CBIR /search/v1|v2|v3
...
// Resultado de búsqueda CBIR (estructura interna)
...
// Respuesta del endpoint con métricas múltiples (V3) /cbir/search/v3/metrics
